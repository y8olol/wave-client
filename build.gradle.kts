...
loom {
    accessWidenerPath = file("src/main/resources/wave-client.accesswidener")
}
...
tasks {
    ...
    jar {
        ...
        manifest {
            attributes["Main-Class"] = "waveclient.waveclient.Main"
        }
    }
...
publishing {
    ...
    repositories {
        maven("https://maven.meteordev.org/snapshots") {
            ...
            credentials {
                username = System.getenv("MAVEN_WAVE_ALIAS")
                password = System.getenv("MAVEN_WAVE_TOKEN")
            }
