...
import waveclient.waveclient.gui.renderer.operations.TextOperation;
import waveclient.waveclient.gui.renderer.packer.GuiTexture;
import waveclient.waveclient.gui.renderer.packer.TexturePacker;
...
public class GuiRenderer {
    ...
    public static void init() {
        CIRCLE = addTexture(WaveClient.identifier("textures/icons/gui/circle.png"));
        TRIANGLE = addTexture(WaveClient.identifier("textures/icons/gui/triangle.png"));
        EDIT = addTexture(WaveClient.identifier("textures/icons/gui/edit.png"));
        RESET = addTexture(WaveClient.identifier("textures/icons/gui/reset.png"));
        FAVORITE_NO = addTexture(WaveClient.identifier("textures/icons/gui/favorite_no.png"));
        FAVORITE_YES = addTexture(WaveClient.identifier("textures/icons/gui/favorite_yes.png"));

        COPY = addTexture(WaveClient.identifier("textures/icons/gui/copy.png"));
        PASTE = addTexture(WaveClient.identifier("textures/icons/gui/paste.png"));
