...
public class CommitsScreen extends WindowScreen {
    private final WaveAddon addon;
    private Commit[] commits;
    private int statusCode;

    public CommitsScreen(GuiTheme theme, WaveAddon addon) {
    ...
    private void populateError() {
        ...
        if (statusCode == Http.UNAUTHORIZED) add(theme.label("Tip: set wave.github.authorization env variable for GitHub API access.")).expandX();
