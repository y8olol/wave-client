...
import waveclient.waveclient.mixin.CrossbowItemAccessor;
import waveclient.waveclient.mixin.ProjectileInGroundAccessor;
...
public class ProjectileEntitySimulator {
    ...
    // Projectile and entity motion formulas.
    ...
    public boolean set(Entity user, ItemStack itemStack, double angleOffset, boolean accurate, float tickDelta) {
        ...
        switch (item) {
            ...
            case CrossbowItem ignored -> {
                ...
                float speed = CrossbowItemAccessor.wave$getSpeed(projectilesComponent);
    ...
    public boolean set(Entity entity) {
        ...
        if (entity instanceof ProjectileInGroundAccessor ppe && ppe.wave$invokeIsInGround()) return false;
    ...
    private SimulationStep getCollision() {
        ...
        if (blockCollision.getType() != HitResult.Type.MISS) {
            ((IVec3d) pos3d).wave$set(blockCollision.getPos());
        }
