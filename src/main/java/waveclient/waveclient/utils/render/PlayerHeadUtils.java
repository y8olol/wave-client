...
import waveclient.waveclient.systems.accounts.TexturesJson;
import waveclient.waveclient.systems.accounts.UuidToProfileResponse;
...
public class PlayerHeadUtils {
    ...
    public static String getSkinUrl(UUID id) {
        UuidToProfileResponse res2 = Http.get("https://sessionserver.mojang.com/session/minecraft/profile/" + id)
            .exceptionHandler(e -> WaveClient.LOG.error("Could not contact mojang session servers.", e))
