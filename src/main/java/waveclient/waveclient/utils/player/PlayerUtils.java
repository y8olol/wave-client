...
import waveclient.waveclient.systems.modules.movement.NoFall;
...
import waveclient.waveclient.utils.misc.text.TextUtils;
...
import static waveclient.waveclient.utils.Utils.WHITE;
...
public class PlayerUtils {
    ...
    public static Vec3d getHorizontalVelocity(double bps) {
        ...
        ((IVec3d) horizontalVelocity).wave$setXZ(velX, velZ);
    ...
    public static boolean canSeeEntity(Entity entity) {
        ...
        ((IVec3d) vec1).wave$set(mc.player.getX(), mc.player.getY() + mc.player.getStandingEyeHeight(), mc.player.getZ());
        ((IVec3d) vec2).wave$set(entity.getX(), entity.getY(), entity.getZ());
        ...
        ((IVec3d) vec2).wave$set(entity.getX(), entity.getY() + entity.getStandingEyeHeight(), entity.getZ());
