...
public class PacketUtilsUtil {
    ...
    public static void init() throws IOException {
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(file))) {
            writer.write("/*\n");
            writer.write(" * This file is part of the Wave Client distribution (https://github.com/WaveDevelopment/wave-client/).\n");
            writer.write(" * Copyright (c) Wave Development.\n");
            writer.write(" */\n\n");

            writer.write("package waveclient.waveclient.utils.network;\n\n");
