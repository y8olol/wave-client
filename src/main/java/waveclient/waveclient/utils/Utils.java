...
package waveclient.waveclient.utils;
...
public class Utils {
    ...
    public static void init() {
        WaveClient.EVENT_BUS.subscribe(Utils.class);
    }
    ...
    public static int getRenderDistance() {
        return Math.max(mc.options.getViewDistance().getValue(), ((ClientPlayNetworkHandlerAccessor) mc.getNetworkHandler()).wave$getChunkLoadDistance());
    }
    ...
    public static void unscaledProjection() {
        ...
        RenderUtils.projection.set(((ProjectionMatrix2Accessor) matrix).wave$callGetMatrix(width, height));
    ...
    public static void getItemsInContainerItem(ItemStack itemStack, ItemStack[] items) {
        ...
        if (components.contains(DataComponentTypes.CONTAINER)) {
            ...
            DefaultedList<ItemStack> stacks = container.wave$getStacks();
    ...
    public static boolean hasItems(ItemStack itemStack) {
        ...
        if (container != null && !container.wave$getStacks().isEmpty()) return true;
    ...
    public static String getWorldName() {
        ...
        if (mc.isInSingleplayer()) {
            ...
            File folder = ((MinecraftServerAccessor) mc.getServer()).wave$getSession().getWorldDirectory(mc.world.getRegistryKey()).toFile();
    ...
    public static byte[] readBytes(InputStream in) {
        try {
            ...
            WaveClient.LOG.error("Error reading from stream.", e);
            return new byte[0];
        } finally {
    ...
    public static void leftClick() {
        ...
        int attackCooldown = ((MinecraftClientAccessor) mc).wave$getAttackCooldown();
        if (attackCooldown == 10000) {
            ((MinecraftClientAccessor) mc).wave$setAttackCooldown(0);
        }

        mc.options.attackKey.setPressed(true);
        ((MinecraftClientAccessor) mc).wave$leftClick();
        mc.options.attackKey.setPressed(false);
    }

    public static void rightClick() {
        ((IMinecraftClient) mc).wave$rightClick();
    }
    ...
    public static boolean isLoading() {
        ResourceReloadLogger.ReloadState state = ((ResourceReloadLoggerAccessor) ((MinecraftClientAccessor) mc).wave$getResourceReloadLogger()).wave$getReloadState();
        return state == null || !((ReloadStateAccessor) state).wave$isFinished();
    }
