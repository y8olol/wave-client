...
package waveclient.waveclient.asm.transformers;

import waveclient.waveclient.asm.AsmTransformer;
import waveclient.waveclient.asm.Descriptor;
import waveclient.waveclient.asm.MethodInfo;
...
public class PacketInflaterTransformer extends AsmTransformer {
    ...
    public void transform(ClassNode klass) {
        ...
        if (method == null) error("[Wave Client] Could not find method PacketInflater.decode()");
        ...
        error("[Wave Client] Failed to modify PacketInflater.decode()");
    }
}
