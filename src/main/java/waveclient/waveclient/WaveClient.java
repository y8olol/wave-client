...
import waveclient.waveclient.utils.ReflectInit;
import waveclient.waveclient.utils.Utils;
import waveclient.waveclient.utils.misc.Version;
import waveclient.waveclient.utils.misc.input.KeyAction;
import waveclient.waveclient.utils.misc.input.KeyBinds;
...
public class WaveClient implements ClientModInitializer {
    public static final String MOD_ID = "wave-client";
    public static final ModMetadata MOD_META;
    public static final String NAME;
    public static final Version VERSION;
    public static final String BUILD_NUMBER;

    public static WaveClient INSTANCE;
    public static WaveAddon ADDON;
    ...
    static {
        ...
        BUILD_NUMBER = MOD_META.getCustomValue(WaveClient.MOD_ID + ":build_number").getAsString();
    }
    ...
    public void onInitializeClient() {
        ...
        // Initialise addons
        AddonManager.ADDONS.forEach(WaveAddon::onInitialize);
    ...
    public static Identifier identifier(String path) {
        return Identifier.of(WaveClient.MOD_ID, path);
    }
}
