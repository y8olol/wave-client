...
import waveclient.waveclient.systems.modules.misc.swarm.SwarmConnection;
import waveclient.waveclient.systems.modules.misc.swarm.SwarmWorker;
import waveclient.waveclient.systems.modules.world.InfinityMiner;
                        ...
                        .then(argument("port", IntegerArgumentType.integer(0, 65535))
                                .executes(context -> {
                                    ...
                                    info(Text.literal("Click here to confirm").setStyle(Style.EMPTY
                                        ...
                                        .withClickEvent(new WaveClickEvent(".swarm join confirm"))
                                    ));
