...
import waveclient.waveclient.mixin.MapTextureManagerAccessor;
...
public class SaveMapCommand extends Command {
    ...
    private void saveMap(int scale) throws CommandSyntaxException {
        ...
        MapTextureManager.MapTexture texture = textureManager.wave$invokeGetMapTexture(map.get(DataComponentTypes.MAP_ID), state);
        ...
        try {
            ...
            WaveClient.LOG.error(e.toString());
        }
    }
