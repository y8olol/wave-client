    ...
    private void onReadPacket(PacketEvent.Receive event) {
        ...
        if (event.packet instanceof CommandTreeS2CPacket packet) {
            ...
            packet.getCommandTree(
                CommandRegistryAccess.of(handler.wave$getCombinedDynamicRegistries(), handler.wave$getEnabledFeatures()),
                ClientPlayNetworkHandlerAccessor.wave$getCommandNodeFactory()
