...
import waveclient.waveclient.asm.Asm;
...
public class MixinPlugin implements IMixinConfigPlugin {
    private static final String mixinPackage = "waveclient.waveclient.mixin";
    ...
    public void onLoad(String mixinPackage) {
        ...
        try {
            ...
            WaveClient.LOG.error("Error loading the mixin plugin", e);
        }
