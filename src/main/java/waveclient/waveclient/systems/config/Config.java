...
package waveclient.waveclient.systems.config;
...
public class Config extends System<Config> {
    ...
    public final Setting<Boolean> titleScreenCredits = sgVisual.add(new BoolSetting.Builder()
        ...
        .description("Show Wave credits on title screen")
        .defaultValue(true)
        .build()
    );
    ...
    public final Setting<Boolean> titleScreenSplashes = sgVisual.add(new BoolSetting.Builder()
        ...
        .description("Show Wave splash texts on title screen")
        .defaultValue(true)
        .build()
    );

    public final Setting<Boolean> waveGlass = sgVisual.add(new BoolSetting.Builder()
        .name("wave-glass")
        .description("Apply Wave glass tint and subtle blur in Wave GUI screens.")
        .defaultValue(true)
        .build()
    );

    public final Setting<Integer> waveGlassTint = sgVisual.add(new IntSetting.Builder()
        .name("wave-glass-tint")
        .description("How strong the blue Wave tint overlay is.")
        .visible(waveGlass::get)
        .defaultValue(72)
        .range(0, 100)
        .sliderRange(0, 100)
        .build()
    ...
    public final Setting<Integer> waveGlassBlur = sgVisual.add(new IntSetting.Builder()
        .name("wave-glass-blur")
        .description("How strong the Wave menu blur is.")
        .visible(waveGlass::get)
        .defaultValue(2)
        .range(1, 6)
        .sliderRange(1, 6)
    ...
    public final Setting<String> customWindowTitleText = sgVisual.add(new StringSetting.Builder()
        ...
        .defaultValue("Minecraft {mc_version} - {wave.name} {wave.version}")
        .onChanged(value -> mc.updateWindowTitle())
        .build()
    );
    ...
    public NbtCompound toTag() {
        ...
        tag.putString("version", WaveClient.VERSION.toString());
