...
package waveclient.waveclient.systems.hud.elements.keyboard;
...
import waveclient.waveclient.mixin.KeyBindingAccessor;
...
import waveclient.waveclient.systems.hud.HudRenderer;
...
public class KeyboardHud extends HudElement {
    ...
    public void render(HudRenderer renderer) {
        ...
        InputUtil.Key guiKey = ((KeyBindingAccessor) KeyBinds.OPEN_GUI).wave$getKey();
    ...
    public static class Key {
        ...
        public boolean matches(int input, int scancode, boolean key) {
            if (keybind != null) {
                ...
                InputUtil.Key inputKey = ((KeyBindingAccessor) binding).wave$getKey();
        ...
        public boolean isNativelyPressed() {
            ...
            if (keybind != null) {
                ...
                int key = ((KeyBindingAccessor) binding).wave$getKey().getCode();
                return key >= 0 && key < 8
