...
import waveclient.waveclient.systems.hud.elements.*;
import waveclient.waveclient.systems.hud.elements.keyboard.KeyboardHud;
...
public class Hud extends System<Hud> implements Iterable<HudElement> {
    public static final HudGroup GROUP = new HudGroup("Wave");
    ...
    private void resetToDefaultElementsImpl() {
        ...
        // Top Left
        add(WaveTextHud.WATERMARK, 4, 4, XAnchor.Left, YAnchor.Top);
        add(WaveTextHud.FPS, 4, 4 + h, XAnchor.Left, YAnchor.Top);
        add(WaveTextHud.TPS, 4, 4 + h * 2, XAnchor.Left, YAnchor.Top);
        add(WaveTextHud.PING, 4, 4 + h * 3, XAnchor.Left, YAnchor.Top);
        add(WaveTextHud.SPEED, 4, 4 + h * 4, XAnchor.Left, YAnchor.Top);

        // Top Right
        add(ActiveModulesHud.INFO, -4, 4, XAnchor.Right, YAnchor.Top);

        // Bottom Right
        add(WaveTextHud.POSITION, -4, -4, XAnchor.Right, YAnchor.Bottom);
        add(WaveTextHud.OPPOSITE_POSITION, -4, -4 - h, XAnchor.Right, YAnchor.Bottom);
        add(WaveTextHud.ROTATION, -4, -4 - h * 2, XAnchor.Right, YAnchor.Bottom);
    }
