...
import waveclient.waveclient.renderer.*;
import waveclient.waveclient.renderer.text.CustomTextRenderer;
import waveclient.waveclient.renderer.text.Font;
import waveclient.waveclient.renderer.text.VanillaTextRenderer;
...
public class HudRenderer {
            ...
            for (Iterator<FontHolder> it = fontsInUse.values().iterator(); it.hasNext(); ) {
                ...
                if (fontHolder.visited) {
                    MeshRenderer.begin()
                        ...
                        .pipeline(WaveRenderPipelines.UI_TEXT)
    ...
    private static class FontHolder {
        ...
        public MeshBuilder getMesh() {
            if (mesh == null) mesh = new MeshBuilder(WaveRenderPipelines.UI_TEXT);
