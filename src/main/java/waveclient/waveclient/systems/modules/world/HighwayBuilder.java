...
import waveclient.waveclient.mixin.ShulkerBoxScreenHandlerAccessor;
...
import waveclient.waveclient.systems.modules.combat.KillAura;
...
import waveclient.waveclient.utils.misc.HorizontalDirection;
import waveclient.waveclient.utils.misc.MBlockPos;
import waveclient.waveclient.utils.player.*;
...
import waveclient.waveclient.utils.world.Dir;
...
public class HighwayBuilder extends Module {
    ...
    private enum State {
        ...
        Forward {
            ...
            private boolean isCrystalTrap(HighwayBuilder b) {
                for (Entity entity : b.mc.world.getEntities()) {
                    ...
                    ((IVec3d) vec1).wave$set(b.mc.player.getX(), b.mc.player.getY() + b.mc.player.getStandingEyeHeight(), b.mc.player.getZ());
                    ((IVec3d) vec2).wave$set(entity.getX(), entity.getY() + 0.5, entity.getZ());
                ...
                switch (blockState.getBlock()) {
                    ...
                    case ShulkerBoxBlock ignored -> {
                        if (b.mc.currentScreen instanceof ShulkerBoxScreen screen) {
                            ...
                            Inventory inv = ((ShulkerBoxScreenHandlerAccessor) screen.getScreenHandler()).wave$getInventory();
        ...
        DefuseCrystalTraps {
             ...
             *
             * @see waveclient.waveclient.mixin.MinecraftClientMixin#wrapStopUsing(ClientPlayerInteractionManager, PlayerEntity)
             */
            @Override
            protected void tick(HighwayBuilder b) {
                if (cooldown > 0) {
