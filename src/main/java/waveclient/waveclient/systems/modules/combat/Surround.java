...
import waveclient.waveclient.mixin.DirectionAccessor;
...
public class Surround extends Module {
    ...
    private boolean place(BlockPos placePos, FindItemResult block) {
        ...
        for (BlockBreakingInfo value : ((WorldRendererAccessor) mc.worldRenderer).wave$getBlockBreakingInfos().values()) {
