...
import waveclient.waveclient.systems.modules.misc.AutoReconnect;
...
public class AutoLog extends Module {
    ...
    private void enableHealthListener() {
        WaveClient.EVENT_BUS.subscribe(staticListener);
    }

    private void disableHealthListener() {
        WaveClient.EVENT_BUS.unsubscribe(staticListener);
    }
}
