...
import waveclient.waveclient.utils.notebot.NotebotUtils;
import waveclient.waveclient.utils.notebot.decoder.SongDecoder;
import waveclient.waveclient.utils.notebot.decoder.SongDecoders;
import waveclient.waveclient.utils.notebot.instrumentdetect.InstrumentDetectMode;
import waveclient.waveclient.utils.notebot.song.Note;
...
public class Notebot extends Module {
    ...
    public void playRandomSong() {
        File[] files = WaveClient.FOLDER.toPath().resolve("notebot").toFile().listFiles();
        ...
        loadingSongFuture.whenComplete((song ,ex) -> {
            if (ex == null) {
                ...
                if (ex instanceof CancellationException) {
                    ...
                    WaveClient.LOG.error("An error occurred while loading song '{}'", FilenameUtils.getBaseName(file.getName()), ex);
                    onSongEnd();
                }
            }
        });
