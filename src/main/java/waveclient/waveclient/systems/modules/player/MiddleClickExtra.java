...
import waveclient.waveclient.events.entity.player.FinishUsingItemEvent;
import waveclient.waveclient.events.entity.player.StoppedUsingItemEvent;
...
public class MiddleClickExtra extends Module {
    ...
    private final Setting<String> friendMessage = sgGeneral.add(new StringSetting.Builder()
        ...
        .defaultValue("/msg %player I just friended you on Wave.")
        .visible(() -> mode.get() == Mode.AddFriend)
        .build()
    );
