...
import waveclient.waveclient.utils.render.MeshBuilderVertexConsumerProvider;
import waveclient.waveclient.utils.render.RenderUtils;
import waveclient.waveclient.utils.render.SimpleBlockRenderer;
...
public class StorageESP extends Module {
    ...
    public StorageESP() {
        ...
        mesh = new MeshBuilder(WaveRenderPipelines.WORLD_COLORED);
    ...
    private void onRender(Render3DEvent event) {
        ...
        if (mode.get() == Mode.Shader && count > 0) {
            MeshRenderer.begin()
                ...
                .pipeline(WaveRenderPipelines.WORLD_COLORED)
